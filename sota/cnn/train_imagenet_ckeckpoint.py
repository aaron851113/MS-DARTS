...
"""
$ cd MS-DARTS/data/
$ scp aaron-lab@140.113.164.70:/media/HDD/ImageNet/ILSVRC2012_img_train.tar ILSVRC2012_img_train.tar
$ scp aaron-lab@140.113.164.70:/media/HDD/ImageNet/ILSVRC2012_img_val.tar ILSVRC2012_img_val.tar
(password:ake1362)
...
$ python train_imagenet.py --arch=(arch)

arch = [c10_s5_ms_darts, c10_s5_ms_darts_best, c10_s5_ms_darts_best2] (see in genotypes.py)
"""

parser = argparse.ArgumentParser("imagenet")
parser.add_argument('--workers', type=int, default=16, help='number of workers to load dataset')
parser.add_argument('--data', type=str, default='../../../../../../media/HDD/ImageNet/', help='location of the data corpus')
...
parser.add_argument('--report_freq', type=float, default=800, help='report frequency') #100
...
args.save = '../../experiments/imagenet/re-eval-{}-{}-{}-{}'.format(
...
def main():
    ...
    if args.arch == 'c10_s5_ms_darts' : 
        check_path = '../../imagenet/eval-EXP-20210622-002203-c10_s5_ms_darts-0-5836/checkpoint.pth.tar'
    elif args.arch ==  'c10_s5_ms_darts_best' :
        check_path = '../../imagenet/eval-EXP-20210622-002350-c10_s5_ms_darts_best-0-8485/checkpoint.pth.tar'
    elif args.arch ==  'c10_s5_ms_darts_best2' :
        check_path = '../../imagenet/eval-EXP-20210622-002542-c10_s5_ms_darts_best2-0-5969/checkpoint.pth.tar'
    else:
        check_path = ''
        print('No found check path')
