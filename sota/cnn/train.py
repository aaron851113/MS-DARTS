...
parser.add_argument('--batch_size', type=int, default=48, help='batch size') #96
...
parser.add_argument('--arch', type=str, default='c10_s5_darts_mean_shift', help='which architecture to use')
parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')
args = parser.parse_args()

args.save = '../../experiments/{}/eval-{}-{}-{}'.format(
    args.dataset, args.save, time.strftime("%Y%m%d-%H%M%S"), args.arch)
if args.cutout:
    args.save += '-cutout'
if args.auxiliary:
    args.save += '-auxiliary'
...
def main():
    ...
    logging.info('Best Valid Accuracy : %f', best_valid_acc)
    #writer.close()
